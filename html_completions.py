...
class TagCompletions(sublime_plugin.EventListener):
    def on_query_completions(self, view, prefix, locations):
        ...
        return ([
            ...
            ("iscookie\tTag", "iscookie name=\"$1\" value=\"\${$2}\" />"),
            ("iscontent\tTag", "iscontent $1/>"),
            ("isredirect\tTag", "isredirect location=\"$1\" />"),
            ("isstatus\tTag", "isstatus value=\"$1\" />"),

            ("isif\tTag", "isif condition=\"\${$1}\">$2</isif>"),
            ("iselse\tTag", "iselse />$1"),
            ("iselseif\tTag", "iselseif condition=\"\${$1}\" />$2"),
            ("isloop\tTag", "isloop items=\"\${$1}\" var=\"$2\">$3</isloop>"),
            ("isnext\tTag", "isnext/>"),
            ("isbreak\tTag", "isbreak/>"),
            ("isinclude\tTag", "isinclude template=\"$1\" />"),
            ("iscomponent\tTag", "iscomponent pipeline=\"$1\" />"),
            ("isset\tTag", "isset name=\"$1\" value=\"\${$2}\" scope=\"${3:page}\" />"),
            ("isremove\tTag", "isremove name=\"$1\" cope=\"${3:page}\" />"),
            ("isscript\tTag", "isscript>$1</isscript>"),
            ("isprint\tTag", "isprint value=\"\${$1}\" encoding=\"${2:off}\" />"),
            ("isslot\tTag", "isslot id=\"$1\" description=\"$2\" context=\"${3:global}\" />"),
            ("iscache\tTag", "iscache status=\"${1:on}\" type=\"${2:relative}\" hour=\"${3:24}\" />"),
            ("isreplace\tTag", "isreplace/>"),
